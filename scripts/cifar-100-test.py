...
try:
    ...
    while not rospy.is_shutdown():
        ...
        if task == 3:
            ...
            #二值化
            ret,threshold=cv2.threshold(Gauss, 127, 255, cv2.THRESH_BINARY);

            circles = cv2.HoughCircles(threshold, cv2.HOUGH_GRADIENT, 1, minDist=40, param1=80, param2=40, minRadius=80, maxRadius=110)
